...
void MainMenu::build_main_menu()
{
	/*
	//DevIL below
	game.icons.title.box.center.x = game.win.width ;
	game.icons.title.box.center.y = game.win.height;

	game.icons.pill.box.center.x = -game.win.width/2.0f;
	game.icons.pill.box.center.y = -game.win.height/2.0f;
	...
	//PPM BELOW
	game.picons.title.box.center.x = game.win.width / 2.0f;
	game.picons.title.box.center.y = game.win.height / 2.0f;

	game.picons.pill.box.center.x = game.win.width / 2.0f;
	game.picons.pill.box.center.y = game.win.height / 4.0f;
	...
	*/
	...
	//SOIL BELOW
	game.sicons.title.box.center.x = game.win.width / 2.0f;
	game.sicons.title.box.center.y = game.win.height / 2.0f;

	game.sicons.pill.box.center.x = game.win.width / 2.0f;
	game.sicons.pill.box.center.y = game.win.height / 4.0f;
